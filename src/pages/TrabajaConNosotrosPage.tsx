    ...
    <Layout>
      <section className="bg-gray-100 py-16 min-h-screen">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-8">Trabaja Con Nosotros</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12">Únete a nuestro equipo</p>
